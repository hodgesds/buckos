...
fn coreutils_9_4() -> PackageInfo {
    PackageInfo {
        ...
        source_hash: Some("ea613a4cf44612326e917201bbbcdfbd301de21ffc3b59b6e5c07e040b275e52".to_string()),
...
fn coreutils_9_5() -> PackageInfo {
    PackageInfo {
        ...
        source_hash: Some("fa613a4cf44612326e917201bbbcdfbd301de21ffc3b59b6e5c07e040b275e53".to_string()),
...
fn util_linux_2_39() -> PackageInfo {
    PackageInfo {
        ...
        runtime_dependencies: vec![],
        source_url: Some("https://www.kernel.org/pub/linux/utils/util-linux/v2.39/util-linux-2.39.tar.xz".to_string()),
        source_hash: Some("32b744f4f3e6b1c8c1d8f7e7e0a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3".to_string()),
...
fn util_linux_2_40() -> PackageInfo {
    PackageInfo {
        ...
        runtime_dependencies: vec![],
        source_url: Some("https://www.kernel.org/pub/linux/utils/util-linux/v2.40/util-linux-2.40.tar.xz".to_string()),
        source_hash: Some("42b744f4f3e6b1c8c1d8f7e7e0a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a4".to_string()),
...
fn findutils_4_9_0() -> PackageInfo {
    PackageInfo {
        ...
        source_hash: Some("a2bfb8c09d436770edc59f50fa483e785b161a3b7b9d547573cb08065fd462fe".to_string()),
...
fn grep_3_11() -> PackageInfo {
    PackageInfo {
        ...
        source_hash: Some("1db2aedde89d0dea42b16d9528f894c8d15dae4e190b59aecc78f5a951276eab".to_string()),
...
fn sed_4_9() -> PackageInfo {
    PackageInfo {
        ...
        source_hash: Some("6e226b732e1cd739464ad6862bd1a1aba42d7982922da7a53519631d24975181".to_string()),
...
fn gawk_5_3_0() -> PackageInfo {
    PackageInfo {
        ...
        source_hash: Some("ca9c16d3d11d0ff8c69d79dc0b47267e1329a69b39b799895604ed447d3ca90b".to_string()),
...
fn diffutils_3_10() -> PackageInfo {
    PackageInfo {
        ...
        source_hash: Some("90e5e93cc724e4ebe12ede80df1634063c7a855f92f8a5fde5e9e0974e353ddd".to_string()),
...
fn patch_2_7_6() -> PackageInfo {
    PackageInfo {
        ...
        source_hash: Some("ac610bda97abe0d9f6b7c963255a11dcb196c25e337c61f94e4778d632f1d8fd".to_string()),
...
fn file_5_45() -> PackageInfo {
    PackageInfo {
        ...
        source_hash: Some("fc97f51029bb0e2c9f4e3bffefdaf678f0e039ee872b9de5c002a6d09c784c82".to_string()),
...
fn which_2_21() -> PackageInfo {
    PackageInfo {
        ...
        source_hash: Some("f4a245b94124b377d8b49646bf421f9155d36aa7614b6ebf83705d3ffc76eaad".to_string()),
...
fn less_643() -> PackageInfo {
    PackageInfo {
        ...
        source_hash: Some("2911b5432c836fa084c8a2e68f182afe46d2d50c728f0ca11ac6f1694d29d5af".to_string()),
...
fn gzip_1_13() -> PackageInfo {
    PackageInfo {
        ...
        source_hash: Some("7454eb6935db17c6655576c2e1b0fabefd38b4d0936e0f87f48cd062ce91a057".to_string()),
...
fn tar_1_35() -> PackageInfo {
    PackageInfo {
        ...
        source_hash: Some("4d62ff37342ec7aed748535323930c7cf94acf71c3591882b26a7ea50f3edc16".to_string()),
...
fn cpio_2_15() -> PackageInfo {
    PackageInfo {
        ...
        source_hash: Some("efa50ef983137eefc0a02fdb51509d624b5e3295c980b127f16ea5637c8b6417".to_string()),
...
fn procps_4_0_4() -> PackageInfo {
    PackageInfo {
        ...
        runtime_dependencies: vec![],
        source_url: Some("https://gitlab.com/procps-ng/procps/-/archive/v4.0.4/procps-v4.0.4.tar.gz".to_string()),
        source_hash: Some("a3b5c6d7e8f9a0b1c2d3e4f5a6b7c8d9e0f1a2b3c4d5e6f7a8b9c0d1e2f3a4b5".to_string()),
...
fn psmisc_23_6() -> PackageInfo {
    PackageInfo {
        ...
        runtime_dependencies: vec![],
        source_url: Some("https://gitlab.com/psmisc/psmisc/-/archive/v23.6/psmisc-v23.6.tar.gz".to_string()),
        source_hash: Some("b4b5c6d7e8f9a0b1c2d3e4f5a6b7c8d9e0f1a2b3c4d5e6f7a8b9c0d1e2f3a4b6".to_string()),
...
fn shadow_4_14_6() -> PackageInfo {
    PackageInfo {
        ...
        runtime_dependencies: vec![],
        source_url: Some("https://github.com/shadow-maint/shadow/releases/download/4.14.6/shadow-4.14.6.tar.xz".to_string()),
        source_hash: Some("c5b6d7e8f9a0b1c2d3e4f5a6b7c8d9e0f1a2b3c4d5e6f7a8b9c0d1e2f3a4b5c6".to_string()),
...
fn sudo_1_9_15() -> PackageInfo {
    PackageInfo {
        ...
        source_hash: Some("d6b7e8f9a0b1c2d3e4f5a6b7c8d9e0f1a2b3c4d5e6f7a8b9c0d1e2f3a4b5c6d7".to_string()),
