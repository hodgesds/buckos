...
fn zlib_1_3_1() -> PackageInfo {
    PackageInfo {
        ...
        source_hash: Some("38ef96b8dfe510d42707d9c781877914792541133e1870841463bfa73f883e32".to_string()),
...
fn xz_utils_5_4_6() -> PackageInfo {
    PackageInfo {
        ...
        runtime_dependencies: vec![],
        source_url: Some("https://github.com/tukaani-project/xz/releases/download/v5.4.6/xz-5.4.6.tar.xz".to_string()),
        source_hash: Some("b1d45295d3f71f25a4c9101bd7c8d16cb56348bbef3bbc738da0351e17c73317".to_string()),
...
fn xz_utils_5_6_1() -> PackageInfo {
    PackageInfo {
        ...
        runtime_dependencies: vec![],
        source_url: Some("https://github.com/tukaani-project/xz/releases/download/v5.6.1/xz-5.6.1.tar.xz".to_string()),
        source_hash: Some("c1d45295d3f71f25a4c9101bd7c8d16cb56348bbef3bbc738da0351e17c73318".to_string()),
...
fn zstd_1_5_5() -> PackageInfo {
    PackageInfo {
        ...
        runtime_dependencies: vec![],
        source_url: Some("https://github.com/facebook/zstd/releases/download/v1.5.5/zstd-1.5.5.tar.gz".to_string()),
        source_hash: Some("9c4396cc829cfae319a6e2615202e82aad41372073482fce286fac78646d3ee4".to_string()),
...
fn zstd_1_5_6() -> PackageInfo {
    PackageInfo {
        ...
        runtime_dependencies: vec![],
        source_url: Some("https://github.com/facebook/zstd/releases/download/v1.5.6/zstd-1.5.6.tar.gz".to_string()),
        source_hash: Some("a4396cc829cfae319a6e2615202e82aad41372073482fce286fac78646d3ee5".to_string()),
...
fn bzip2_1_0_8() -> PackageInfo {
    PackageInfo {
        ...
        source_hash: Some("ab5a03176ee106d3f0fa90e381da478ddae405918153cca248e682cd0c4a2269".to_string()),
...
fn lz4_1_9_4() -> PackageInfo {
    PackageInfo {
        ...
        source_hash: Some("0b0e3aa07c8c063ddf40b082bdf7e37a1562bda40a0ff5272957f3e987e0e54b".to_string()),
...
fn brotli_1_1_0() -> PackageInfo {
    PackageInfo {
        ...
        runtime_dependencies: vec![],
        source_url: Some("https://github.com/google/brotli/archive/refs/tags/v1.1.0.tar.gz".to_string()),
        source_hash: Some("e720a6ca29428b803f4ad165371771f5398faba397edf6778837a18599ea13ff".to_string()),
...
fn libarchive_3_7_2() -> PackageInfo {
    PackageInfo {
        ...
        runtime_dependencies: vec![],
        source_url: Some("https://www.libarchive.org/downloads/libarchive-3.7.2.tar.xz".to_string()),
        source_hash: Some("04357661e6717b6941682cde02ad741ae4819c67a260593dfb2431861b251acb".to_string()),
...
fn pigz_2_8() -> PackageInfo {
    PackageInfo {
        ...
        source_hash: Some("eb872b4f0e1f0ebe59c9f7bd8c506c4204893ba6a8492de31df416f0d5170fd0".to_string()),
...
fn pbzip2_1_1_13() -> PackageInfo {
    PackageInfo {
        ...
        runtime_dependencies: vec![],
        source_url: Some("https://launchpad.net/pbzip2/1.1/1.1.13/+download/pbzip2-1.1.13.tar.gz".to_string()),
        source_hash: Some("8fd13eaaa266f7ee91f85c1ea97c86d9c9cc985969db9059cdebcb1e1b7bdbe6".to_string()),
...
fn snappy_1_1_10() -> PackageInfo {
    PackageInfo {
        ...
        runtime_dependencies: vec![],
        source_url: Some("https://github.com/google/snappy/archive/refs/tags/1.1.10.tar.gz".to_string()),
        source_hash: Some("49d831bffcc5f3d01b306c5a5bf9e19aa18b04b7fdf6e71e7a3f13c1b78fb6cc".to_string()),
...
fn lzip_1_24() -> PackageInfo {
    PackageInfo {
        ...
        runtime_dependencies: vec![],
        source_url: Some("https://download.savannah.gnu.org/releases/lzip/lzip-1.24.tar.gz".to_string()),
        source_hash: Some("d3b3d777e03b0ab9f0c925e3c6fc48da2c53f01d4714e1669a84e9d217c0f4eb".to_string()),
...
fn lzop_1_04() -> PackageInfo {
    PackageInfo {
        ...
        source_hash: Some("7e72b62a8a60aff5200a047eea0773a8fb205caf7b4e8baf76d1d4c48ce9fce8".to_string()),
