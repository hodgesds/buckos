...
fn cmake_3_28_3() -> PackageInfo {
    PackageInfo {
        ...
        source_hash: Some(
            "72b7570e5c8593de6ac4ab433b73eab18c5fb328f3e74f53e5e8f4a93f8c8f0e".to_string(),
        ),
...
fn cmake_3_29_0() -> PackageInfo {
    PackageInfo {
        ...
        source_hash: Some(
            "82b7570e5c8593de6ac4ab433b73eab18c5fb328f3e74f53e5e8f4a93f8c8f1f".to_string(),
        ),
...
fn meson_1_3_2() -> PackageInfo {
    PackageInfo {
        ...
        keywords: vec!["amd64".to_string(), "arm64".to_string(), "x86".to_string()],
        use_flags: vec![use_flag("test", "Build tests", false)],
        dependencies: vec![dep("dev-lang", "python")],
        build_dependencies: vec![dep_build("dev-python", "setuptools")],
        runtime_dependencies: vec![dep("dev-util", "ninja")],
        source_url: Some(
            "https://github.com/mesonbuild/meson/releases/download/1.3.2/meson-1.3.2.tar.gz"
                .to_string(),
        ),
        source_hash: Some(
            "4533a43c34548edd1f63a276b42d95e4dc4a7df0c71f8905d6c7a54f2f9a3b5c".to_string(),
        ),
...
fn meson_1_4_0() -> PackageInfo {
    PackageInfo {
        ...
        source_hash: Some(
            "5533a43c34548edd1f63a276b42d95e4dc4a7df0c71f8905d6c7a54f2f9a3b6d".to_string(),
        ),
...
fn ninja_1_11_1() -> PackageInfo {
    PackageInfo {
        ...
        runtime_dependencies: vec![],
        source_url: Some(
            "https://github.com/ninja-build/ninja/archive/refs/tags/v1.11.1.tar.gz".to_string(),
        ),
        source_hash: Some(
            "31747ae633213f1eda3842686f83c2aa1412e0f5691d1c14dbbcc67fe7400cea".to_string(),
        ),
...
fn ninja_1_12_0() -> PackageInfo {
    PackageInfo {
        ...
        runtime_dependencies: vec![],
        source_url: Some(
            "https://github.com/ninja-build/ninja/archive/refs/tags/v1.12.0.tar.gz".to_string(),
        ),
        source_hash: Some(
            "41747ae633213f1eda3842686f83c2aa1412e0f5691d1c14dbbcc67fe7400ceb".to_string(),
        ),
...
fn scons_4_7_0() -> PackageInfo {
    PackageInfo {
        ...
        runtime_dependencies: vec![],
        source_url: Some(
            "https://github.com/SCons/scons/archive/refs/tags/4.7.0.tar.gz".to_string(),
        ),
        source_hash: Some(
            "d6b3e5b5f9e3a2c0e5a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7".to_string(),
        ),
...
fn bazel_7_1_0() -> PackageInfo {
    PackageInfo {
        ...
        use_flags: vec![use_flag("examples", "Install examples", false)],
        dependencies: vec![dep("dev-lang", "python"), dep("sys-libs", "zlib")],
        build_dependencies: vec![dep_build("dev-java", "openjdk")],
        runtime_dependencies: vec![],
        source_url: Some(
        ...
        source_hash: Some(
            "e7b8f9a0b1c2d3e4f5a6b7c8d9e0f1a2b3c4d5e6f7a8b9c0d1e2f3a4b5c6d7e8".to_string(),
        ),
...
fn buck2_2024_01() -> PackageInfo {
    PackageInfo {
        ...
        use_flags: vec![],
        dependencies: vec![dep("dev-lang", "python")],
        build_dependencies: vec![dep_build("dev-lang", "rust")],
        runtime_dependencies: vec![],
        source_url: Some(
            "https://github.com/facebook/buck2/releases/download/2024-01-01/buck2.tar.gz"
                .to_string(),
        ),
        source_hash: Some(
            "f8b9c0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9".to_string(),
        ),
