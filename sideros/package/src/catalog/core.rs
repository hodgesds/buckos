...
fn glibc_2_38() -> PackageInfo {
    PackageInfo {
        ...
        runtime_dependencies: vec![
            dep("sys-libs", "timezone-data"),
        ],
        source_url: Some("https://ftp.gnu.org/gnu/glibc/glibc-2.38.tar.xz".to_string()),
        source_hash: Some("fb82998998b2b29965467bc1b69d152e9c307d2cf301c9eafb4555b770ef3fd2".to_string()),
...
fn glibc_2_39() -> PackageInfo {
    PackageInfo {
        ...
        source_hash: Some("f77bd47cf8e0cb395eb8fdf77dda3fb8cf9c1d57c15bdf3d3d36c53ceb0d9a2d".to_string()),
...
fn musl_1_2_4() -> PackageInfo {
    PackageInfo {
        ...
        use_flags: vec![
            use_flag("static-libs", "Build static libraries", true),
        ],
        dependencies: vec![
            dep("sys-kernel", "linux-headers"),
        ],
        ...
        source_hash: Some("7a35eae33d5372a7c0da1188de798726f68825513b7ae3ebe97aaaa52114f039".to_string()),
...
fn musl_1_2_5() -> PackageInfo {
    PackageInfo {
        ...
        source_hash: Some("a9a118bbe84d8764da0ea0d28b3ab3fae8477fc7e4085d90102b8596fc7c75e4".to_string()),
...
fn linux_headers_6_6() -> PackageInfo {
    PackageInfo {
        ...
        build_dependencies: vec![],
        runtime_dependencies: vec![],
        source_url: Some("https://www.kernel.org/pub/linux/kernel/v6.x/linux-6.6.tar.xz".to_string()),
        source_hash: Some("d55f5a834fd6cd2a70e3c5a7e2e5e0f7cc1d7a9be7b6c17f6daf82e4e06a5f3a".to_string()),
...
fn linux_headers_6_8() -> PackageInfo {
    PackageInfo {
        ...
        build_dependencies: vec![],
        runtime_dependencies: vec![],
        source_url: Some("https://www.kernel.org/pub/linux/kernel/v6.x/linux-6.8.tar.xz".to_string()),
        source_hash: Some("c969dea4e8bb6be991bbf7c010ba0e0a5643a3a8d8fb0a2b9e1c8d9c0e7f6b5c".to_string()),
...
fn timezone_data_2024a() -> PackageInfo {
    PackageInfo {
        ...
        keywords: vec!["amd64".to_string(), "arm64".to_string(), "x86".to_string()],
        use_flags: vec![
            use_flag("leaps", "Install leap second data", false),
        ],
        dependencies: vec![],
        build_dependencies: vec![],
        runtime_dependencies: vec![],
        source_url: Some("https://data.iana.org/time-zones/releases/tzdata2024a.tar.gz".to_string()),
        source_hash: Some("0d0434459acbd2059a7a8da1f3304a84a86591f6ed69c6248fffa502b6edffe3".to_string()),
...
fn ncurses_6_4() -> PackageInfo {
    PackageInfo {
        ...
        source_hash: Some("6931283d9ac87c5073f30b6290c4c75f21632bb4fc3603ac8100812bed248159".to_string()),
...
fn readline_8_2() -> PackageInfo {
    PackageInfo {
        ...
        source_hash: Some("3feb7171f16a84ee82ca18a36d7b9be109a52c04f492a053331571d0f8e7d8f4".to_string()),
...
fn libffi_3_4_6() -> PackageInfo {
    PackageInfo {
        ...
        runtime_dependencies: vec![],
        source_url: Some("https://github.com/libffi/libffi/releases/download/v3.4.6/libffi-3.4.6.tar.gz".to_string()),
        source_hash: Some("b0dea9df23c863a7a50e825440f3ebffabd65df1497108e5d437747843895a4e".to_string()),
...
fn gmp_6_3_0() -> PackageInfo {
    PackageInfo {
        ...
        build_dependencies: vec![
            dep_build("sys-devel", "gcc"),
            dep_build("sys-devel", "m4"),
        ],
        runtime_dependencies: vec![],
        source_url: Some("https://gmplib.org/download/gmp/gmp-6.3.0.tar.xz".to_string()),
        source_hash: Some("a3c2b80201b89e68616f4ad30bc66aee4927c3ce50e33929ca819d5c43538898".to_string()),
...
fn mpfr_4_2_1() -> PackageInfo {
    PackageInfo {
        ...
        source_hash: Some("277807353a6726978996945af13e52829e3abd7a9a5b7fb2793894e18f1fcbb2".to_string()),
...
fn mpc_1_3_1() -> PackageInfo {
    PackageInfo {
        ...
        slot: "0/3".to_string(),
        description: "Library for the arithmetic of complex numbers with high precision".to_string(),
        ...
        source_hash: Some("ab642492f5cf882b74aa0cb730cd410a81edcdbec895183ce930e706c1c759b8".to_string()),
...
fn libcap_2_69() -> PackageInfo {
    PackageInfo {
        ...
        runtime_dependencies: vec![],
        source_url: Some("https://kernel.org/pub/linux/libs/security/linux-privs/libcap2/libcap-2.69.tar.xz".to_string()),
        source_hash: Some("f311f8f3dad84699d0566d1d6f7ec943a9298b28f714cae3c931dfd57492d7eb".to_string()),
...
fn attr_2_5_2() -> PackageInfo {
    PackageInfo {
        ...
        runtime_dependencies: vec![],
        source_url: Some("https://download.savannah.gnu.org/releases/attr/attr-2.5.2.tar.gz".to_string()),
        source_hash: Some("39bf67452fa41d0948c2197601053f48b3d78a029389734332a6309a680c6c87".to_string()),
...
fn acl_2_3_2() -> PackageInfo {
    PackageInfo {
        ...
        runtime_dependencies: vec![],
        source_url: Some("https://download.savannah.gnu.org/releases/acl/acl-2.3.2.tar.xz".to_string()),
        source_hash: Some("5f2bdbad629707aa7d85c623f994aa8a1d2dec55a73de5205bac0bf6058a2f7c".to_string()),
