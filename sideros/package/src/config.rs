...
impl Default for Config {
    fn default() -> Self {
        ...
        Self {
            root: PathBuf::from("/"),
            db_path: PathBuf::from("/var/db/sideros"),
            cache_dir: PathBuf::from("/var/cache/sideros"),
            buck_repo: PathBuf::from("/var/db/repos/sideros"),
...
impl Config {
    ...
    pub fn load() -> Result<Self> {
        let config_path = PathBuf::from("/etc/sideros/sideros.toml");
...
impl Default for RepositoryConfig {
    fn default() -> Self {
        Self {
            ...
            sync_uri: "https://github.com/sideros/packages.git".to_string(),
            priority: 0,
            auto_sync: true,
        }
    }
