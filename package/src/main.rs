...
/// Generate Buck2 modifier configuration (install_modifiers.bzl)
///
/// Produces a Starlark file compatible with buckos-build's modifier system.
/// The root PACKAGE loads this and applies modifiers via set_modifiers().
fn generate_config_bzl(profile: &str, flags: &[String], _arch: &str) -> String {
    ...
    format!(
        r#"# BuckOS Modifier Configuration
